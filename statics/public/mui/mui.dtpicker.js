...
(function($, document) {
	...
	var domBuffer = '<div class="mui-dtpicker" data-type="datetime">\
		<div class="mui-dtpicker-header">\
			<button data-id="btn-cancel" class="aui-btn bg-color-white">取消</button>\
			<button data-id="btn-ok" class="aui-btn aui-btn-info">确定</button>\
		</div>\
	...
	var DtPicker = $.DtPicker = $.Class.extend({
		...
		_create: function(options) {
			...
			options.beginYear = options.beginYear || (now.getFullYear() - 80);

	    			...
	    			if(ret.data[k].meeting_type==type_noo){
	    				$("#"+type_noo).append(
	    					'<li class="bb-1-df pt-15em" onclick="openSignIn(\'oa_attmeeting_signIn_header\','+ret.data[k].meeting_no+')">'+
					            '<div class="over-h">'+
					            	'<img class="w-118em h-98em bor-ra-3 pull-left mr-12em" src="'+((ret.data[k].meetting_thumb!='')?localStorage.url+ret.data[k].meetting_thumb:'../../../statics/public/aui2/img/oa_qiandao_info.png')+'"/>'+
